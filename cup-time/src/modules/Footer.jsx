    ...
    <footer  className="footer">
        <div className="container footer__container">
            <a className="footer__logo">
                <img src="/src/assets/image/logo.svg" alt="Логотип Cup Time" className="footer__logo"></img>
            </a>
            ...
            <div className="footer__info">
                ...
                <ul className="footer__developers">
                    <li className="footer__developer">Designer: <a href="#" className="footer__developer-link">Anastasia Illina</a></li>
                    <li className="footer__developer">Developer: <a href="#" className="footer__developer-link">Daniil Mayorov</a></li>
                </ul>
            </div>
